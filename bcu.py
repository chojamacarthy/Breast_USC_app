...
model_sizes_df = pd.DataFrame({
    ...
    "Accuracy": [0.8211, 0.8075, 0.7835, 0.8223, 0.8045, 0.8045],
    "Precision": [0.8209, 0.8082, 0.7838, 0.8203, 0.8065, 0.8052],
    "Recall": [0.8211, 0.8075, 0.7835, 0.8223, 0.8045, 0.8045],
    "F1_Score": [0.821, 0.8078, 0.7836, 0.8201, 0.8053, 0.8048],
})
